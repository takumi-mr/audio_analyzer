...
class AudioAnalyzer:
    ...
    def __init__(self, reader: IAudioReader, writer: IResultWriter, strategy: IAnalysisStrategy, filters: Optional[List[IAudioFilter]] = None):
        # 依存性の注入 (DI)
        self._reader = reader
        self._writer = writer
    ...
    def process(self, input_paths: Dict[str, str], output_path: str, params: Optional[Dict[str, Any]] = None) -> None:
    ...
    def process_multi(self, input_paths: Dict[str, str], strategies: List[IAnalysisStrategy], output_path: str, params: Optional[Dict[str, Any]] = None) -> None:
        ...
        for strategy in strategies:
            ...
            for k, v in result.items():
                if k == "status":
                    ...
                    merged_result["message"] = (merged_result.get("message", "") + "; " + v).strip("; ")
                else:
                    merged_result[k] = v
